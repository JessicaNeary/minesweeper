...
var board = {
  cells: [new cell(1,1), new cell(0,1), new cell(1,0), new cell(0,0), new cell(0,2), new cell(1,2), new cell(2,0), new cell(2,1), new cell(2,2)]
}
...
function countSurroundingMines (cell) {
  ...
  //   if(board.cells[surroundingCells[i]].isMine === true){
  //     count++;
  //   }
  // }
  // return count;
